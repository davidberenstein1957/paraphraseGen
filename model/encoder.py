...
class EncoderHR(nn.Module):
    def __init__(self, params):
        ...
        self.linear_mu = nn.Linear(self.params.encoder_rnn_size*2, self.params.encoder_rnn_size*2)
        self.linear_var = nn.Linear(self.params.encoder_rnn_size*2, self.params.encoder_rnn_size*2)
