...
class TDNN(nn.Module):
    def __init__(self, params: dict) -> None:
        """
        [summary] initializes the tdnn module

        Args:
            params (dict): [description] parameters from the initialized RVAE
        """
        ...
        self.kernels = [
            Parameter(t.Tensor(out_dim, self.params.char_embed_size, kW).uniform_(-1, 1))
    ...
    def _add_to_parameters(self, parameters: object, name: str) -> None:
        """ add parameters from main RVAE to tdnn """
